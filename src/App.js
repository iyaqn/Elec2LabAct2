  ...
  return (
    ...
    <div className="header2 z-3 sticky-top">
      ...
      <div className="design1" >
        <span > <a href=""> <img src="./store-finder.png"/> Store Finder</a> </span>
        <span> <a href=""> <img src="./blog.png"/> Blog </a> </span>
        <span> <a href=""> <img src="./bulk-orders.png"/> Bulk Orders</a> </span>
        <span> <a href=""> <img src="./laking-national.png"/> Laking National </a> </span>
        <span> <a href=""> <img src="./help.png"/> Help </a> </span>
        <span> <a href=""> <img src="./contact-us.png"/> Contact Us </a> </span>
        <span> <img src="./delivery-hotline.png"/> Delivery Hotline 8-8888-627  </span>

      </div>
      <div className="design2">
      <span> <a href=""> Hi Guest </a> </span>
      <span> <a href=""> Sign in </a> </span>
      </div>
    </div>
    <div class="container-fluid">
      <a class="navbar-brand"><img src="./logo1.jpg" style={{marginLeft:"200px"}}/></a>
      <form class="d-flex" role="search">
        <input class="form-control me-2" style={{width:"1000px"}} type="search" placeholder="Search our catalogue" aria-label="Search"/>
        <button class="btn btn-outline-success" type="submit"><img className="imgg" src="./search.png"/></button>
      </form>
      <div className="design2">
      <a href=""> <img className="imgg" src="./user.png"/> </a>
       <a href=""> <img className="imgg" src="./heart.png"/> </a> 
     <a href=""> <img className="imgg" src="./shopping-cart.png"/> </a> 
      </div>
 
    </div>
    <div className="designnavbar">
    <span><a href="">Sale Items</a></span>
    <span><a href="">Shop by Category </a></span>
    <span><a href=""> eBooks</a></span>
    <span><a href="">New Arrivals</a></span>
    <span><a href="">Wattpad</a></span>
    <span><a href="">Manga</a></span>
    <span><a href="">KPOP</a></span>
    <span><a href="">Gift Cards</a></span>
    <span><a href="">eVouchers</a></span>
    <span><a href="">P99 Books</a></span>
    <span><a href="">Pre-order</a></span>
   </div>
  </nav>
    </div>
  );
...
function Breadcrumb (){
  ...
  return (
    <div style={{marginLeft:"200px", marginBottom:"20px", marginTop:"20px"}}>
    <Stack spacing={2}>
...
function Div1() {
  ...
  return (
    <div className="div1">
      <div style={{borderBottom:"solid", marginTop:"10px", borderWidth:"1px"}} >
        <h6>Price</h6>
        <Box sx={{ width: 200 }}>
      <Slider
  ...
  <TextField 
  style={{display:"inline-block", width:"100px", marginBottom:"10px"}}
      id="outlined-basic" 
      label="" 
      variant="outlined" 
      InputProps={{
    ...
    <div style={{borderBottom:"solid", marginTop:"10px", borderWidth:"1px"}}>
      ...
      <FormControlLabel control={<Checkbox  />} label="Villa-Real, Aya (1)" />
      </FormGroup>
    </div>
    <div style={{borderBottom:"solid", marginTop:"10px", borderWidth:"1px"}}>
      <h6> Book Format </h6>
      ...
      <FormControlLabel control={<Checkbox  />} label="Trade Paperback (10)" /> 
...
const bookData = Data();
  const handleChange = (event) => {
    ...
    return (
      ...
      <span><h6> Showing 1 - 16 of 16 items.  </h6></span>
     </div>
    )
  }
  ...
  <button class="butn" type="button" id="button-addon2">Subscribe</button>
</div>
</div>
<div className="semifooter">
...
<a href=""> <img className="logo" src="./igicon.png"/> </a> 
<a href=""> <img className="logo" src="./fblogo.png"/> </a> 
<a href=""> <img className="logo" src="./t.png"/> </a> 
<a href=""> <img className="logo" src="./yt.png"/> </a> 
          </div>
</div>
      </div>
      </div>
